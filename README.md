...
# Customer Risk & Claims Analysis for an Insurance Company  (DataForge Africa)
## 1. PROJECT OVERVIEW
This project analyses customer, policy, and claims data to uncover insights and recommend actions to improve profitability and reduce risk.
...
Claim trend overtime
Claims by policy type
Claims status breakdown
Provincial fraud cases
